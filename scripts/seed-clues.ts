...
const SEED_CLUES: SeedClue[] = [
  ...
  },
  {
    ...
    clue_type_slug: "double-definition",
    annotation:
      "DOUBLE DEFINITION: BOMBSHELL = stunning person & BOMBSHELL = explosive",
  ...
  // ── Cryptic Definitions ──
  {
    ...
    annotation:
      'CRYPTIC DEFINITION: "hard cheese" = bad luck expression & literal solid food',
  ...
  },
  {
    ...
    clue_type_slug: "cryptic-definition",
    annotation:
      'CRYPTIC DEFINITION: "down in the mouth" = miserable & duck feathers going in your mouth',
    definition_part: "Miserable",
    wordplay_part:
      "entire clue is a punning definition involving eating duck (down)",
    difficulty: 3,
    source: "Times Cryptic 29459",
    is_verified: true,
  },
